        ...
        <div class="card card-success">
          ...
          <form action="{{ url('deliveries' ) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                <div class="col-md-6 mb-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="image" id="image" accept=".jpeg, .png, .jpg, .gif, .svg" onchange="validateSize()">
                  </div>
                </div>
                <div class="col-md-6 mb-2">
            ...
            <div class="card-footer bg-whitesmoke text-md-right">
              <button class="btn btn-primary" id="save-btn">Send</button>
            </div>
          </form>
        </div>
      </div>
