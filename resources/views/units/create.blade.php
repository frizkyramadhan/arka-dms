            ...
            <form action="{{ url('units') }}" method="post">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control @error('unit_name') is-invalid @enderror" name="unit_name" value="{{ old('unit_name') }}">
                  @error('unit_name')
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <select name="unit_status" class="form-control @error('unit_status') is-invalid @enderror">
                    ...
                    <option value="1" {{ old('unit_status') == '1' ? 'selected' : '' }}>Active</option>
                    <option value="0" {{ old('unit_status') == '0' ? 'selected' : '' }}>Inactive
                    </option>
                  </select>
                  @error('unit_status')
                  <div class="invalid-feedback">
